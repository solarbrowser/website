    ...
    <div className={`min-h-screen py-24 px-6 ${theme === 'dark' ? 'bg-[#232223] text-[#f9f9f9]' : 'bg-[#FAF9F7] text-[#1a1a1a]'}`}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Customize Your Browser</h1>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Make Solar truly yours. Customize every aspect of your browsing experience.
          </p>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">Customization Features Coming Soon</h2>
          <p className="text-white/60 text-lg mb-8 max-w-xl mx-auto">
            This page will be updated with detailed customization options once our alpha release is ready. Join the waitlist to be notified.
          </p>
          <button
